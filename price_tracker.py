...
Info  : https://brightdata.jp/products/insights/price-tracker/noon
"""
...
# https://brightdata.jp/products/web-scraper/noon
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Noon scraper at: https://brightdata.jp/products/web-scraper/noon\n"
